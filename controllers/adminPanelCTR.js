...
const signInPage = (req, res) => {
    ...
    res.render('auth/signInPage', { errormsg, success: req.flash("success"), error: req.flash("error"), });
...
const signUpPage = (req, res) => {
    res.render('auth/signUpPage', { error: req.flash('error'), success: req.flash('success') });
};
...
const addAdminPage = (req, res) => {
    res.render('admin/addAdminPage', { success: req.flash('success'), error: req.flash('error') });
}
const viewProfile = async (req, res) => {
    const currentAdmin = req.user;
    console.log(currentAdmin);

    res.render('admin/adminProfile', { currentAdmin, success: req.flash('success'), error: req.flash('error') });
}
...
const editCurrentAdmin = async (req, res) => {
    ...
    try {
        ...
        if (record) {
            res.render('admin/editCurrentAdminPage', { record, currentAdmin, success: req.flash("success"), error: req.flash("error") });
        } else {
...
const changePasswordPage = (req, res) => {
    res.render('changePassword/changePasswordPage', { error: req.flash('error'), success: req.flash('success') });
}
...
const adminTable = async (req, res) => {
    if (!req.user) {
        ...
        try {
            ...
            res.render('admin/adminTable', { records, currentAdmin, success: req.flash('success'), error: req.flash('error') });
        } catch (e) {
...
const editAdminPage = async (req, res) => {
    ...
    try {
        ...
        if (record) {
            res.render('admin/editAdminPage', { record, success: req.flash("success"), error: req.flash("error"), });
        } else {
